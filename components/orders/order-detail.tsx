  ...
  return (
    <div className='mx-auto w-full space-y-4 sm:space-y-6'>
      ...
      <div className='grid gap-6 lg:grid-cols-5'>
        {/* Left: items + totals (lg: col-span-3) */}
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              {order.items.map((item: OrderItemWithImage) => (
                <div
                  key={item.id}
                  className='flex items-center gap-4 last:pb-0 pb-4 last:border-b-0 border-b border-slate-200'
                >
                  ...
                  <p className='shrink-0 sm:text-lg font-semibold'>
        ...
        {/* Right: shipping, payment, shipment, timeline (lg: col-span-2) */}
          ...
          <Card>
            ...
            <CardContent className='space-y-2 text-sm'>
              ...
              <div className='flex justify-between'>
                ...
                <span className='font-medium'>
                  {order.shipment_method ?? order.shipment_methods?.code ?? '—'}
                </span>
              </div>
            </CardContent>
          </Card>
