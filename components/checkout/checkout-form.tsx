...
export default function CheckoutForm({
  ...
  const [pendingSubmitEvent, setPendingSubmitEvent] =
    useState<SubmitEvent<HTMLFormElement> | null>(null)
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent size='default'>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Please review your shipping address and order details. Once
              confirmed, your order will be placed and you will be charged
              accordingly.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
